...
********************************************************************************
global d "/Volumes/Samsung USB/Officer Down/Data"
...
*dealing with missing data on some vars
recode q6_age (999 = .)
recode q14_ambush (3 = .)
...
********************************************************************************
*leaving 9/11 related deaths as non-felonious
recode deathtype (1 = 0) if q10_cod == 1
*****


*re-create fig 1 from CPP paper
collapse (sum) tot_ofc_deaths felonious non_felonious ambush, by(q5_end_of_watch_yr)
*add total ofcs per year to create rate
...
*take three-year avg (2018, 2019, 2020) for the 2021 estimates*****
di (704744+712697+718906)/3
replace tot_ofcs = 712115.67 if q5_end_of_watch_yr == 2021 
...
gen ambush_rate = (ambush * 100000) / tot_ofcs

*felonious ofc deaths over time - raw
...
*take three-year avg of each state (2018, 2019, 2020) for the 2021 estimates****
...
replace tot_ofcs = 5413 if q4_state == 15 & q5_end_of_watch_yr == 2020
...
replace tot_ofcs = 2515 if q4_state == 39 & q5_end_of_watch_yr == 2020
...
foreach v in local_agency county_agency state_agency federal corrections other january febuary march april may june july august september october november december front_line supervisor detective management sex assault1 gunfire1 stabbed1 terrorist_attack1 vehicle_pursuit1 vehicular_ass1 other_cause1 q18_alone q19_spouse q20_children q21_off_duty {
...
foreach v in local_agency county_agency state_agency federal corrections other january febuary march april may june july august september october november december front_line supervisor detective management sex aircraft1 auto_bike_acc1 gun_acc1 heart_attack1 struckby_veh1 drowned1 other_cause3 q18_alone q19_spouse q20_children q21_off_duty {
...
replace tot_ofcs = 712697 if q5_end_of_watch_yr == 2019
replace tot_ofcs = 718906 if q5_end_of_watch_yr == 2020
replace tot_ofcs = 665380 if q5_end_of_watch_yr == 2021 
...
drop if q5_end_of_watch_mo == 9 & q5_end_of_watch_yr == 2001
line felonious modate, lw(medthick) title("Monthly Felonious line-of-duty deaths and death rates, 1970-2021", size(small))		
